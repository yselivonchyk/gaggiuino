...
```
4.1 Mac
4.1.1 Connect adruino with a usb cable
4.1.2 Open Adruino app
4.1.3 Choose port in Tools -> Ports
4.1.4 Copy the content of gagguino.ino file into the editor
4.1.5 Press upload button on top
```
